...
import * as Plugin_2 from 'U:/TH01/src/.umi/plugin-access/rootContainer.ts';
import * as Plugin_3 from '../plugin-initial-state/runtime';
import * as Plugin_4 from 'U:/TH01/src/.umi/plugin-locale/runtime.tsx';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: 'U:/TH01/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
  ...
  plugin.register({
    apply: Plugin_4,
    path: 'U:/TH01/src/.umi/plugin-locale/runtime.tsx',
  });
  plugin.register({
    apply: Plugin_5,
